        ...
        <div className="login2-middle">
          <main className="login2-card">
            ...
            <div className="login2-content">
              ...
              {success && (
                <div className="login2-alert-success" role="alert" aria-live="assertive" aria-atomic="true" style={{
                  padding: '12px 16px',
                  marginBottom: '16px',
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="login2-info-text" style={{ 
                    fontSize: '13px', 
                  ...
                  <div className="login2-footer-text" style={{ marginBottom: '16px' }}>
                    <span>No account? </span>
                    <Link href="/signup" className="login2-create-link">
                      Create one!
                    </Link>
                  </div>
                  ...
                  <div className="login2-actions">
                    <button
                      ...
                      disabled={isLoading || !!success}
                    >
                      {isLoading ? 'Sending magic link...' : success ? 'Check your email' : 'Send magic link'}
                    </button>
                  </div>
                </form>
                  </div>
    ...
    <footer className="login2-footer">
      <div className="login2-footer-row">
        <div className="login2-footer-links">
            <a href="#" className="login2-footer-link">Privacy statement</a>
            <span className="login2-footer-info">©2025 Microsoft</span>
          </div>
      </div>
    </footer>
  </>
